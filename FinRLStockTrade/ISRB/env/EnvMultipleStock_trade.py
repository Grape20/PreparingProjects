...
class StockEnvTrade(gym.Env):
    ...
    def __init__(self, df,day = 0,turbulence_threshold=140
        ...
        # Shape = 19: [Current Balance]+[prices 1-30]+[owned shares 1-3] 
        # +[macd 1-3]+ [rsi 1-3] + [cci 1-3] + [adx 1-3]
        self.observation_space = spaces.Box(low=0, high=np.inf, shape = (1+6*STOCK_DIM,))
